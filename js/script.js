...
async function getSongs(folder) {
    ...
    for (const song of songs) {
        songUL.innerHTML = songUL.innerHTML + `<li><img class="invert" width="34" src="image/music.svg" alt="">
                            <div class="info">
...
async function displayAlbums() {
    ...
    for (let index = 0; index < array.length; index++) {
        ...
        if (e.href.includes("/songs") && !e.href.includes(".htaccess")) {
            let folder = new URL(e.href).pathname.split("/").filter(Boolean).pop(); // ✅ Correct folder name
